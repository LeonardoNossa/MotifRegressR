...
```{r PFM_loader}
path_PFM <- system.file("extdata/E.coli", "SwissRegulon_e_coli.meme", package = "MotifRegressR")
...
path_fasta <- system.file("extdata/E.coli", "GCF_000005845.2_ASM584v2_genomic.fna", package = "MotifRegressR")
...
```{r, get_sequences}
path_gff <- system.file("extdata/E.coli", "GCF_000005845.2_ASM584v2_genomic.gff", package = "MotifRegressR")
path_fasta <- system.file("extdata/E.coli", "GCF_000005845.2_ASM584v2_genomic.fna", package = "MotifRegressR")
...
```{r, compendium_loader}
path_compendium <- system.file("extdata/E.coli", "compendium.csv", package = "MotifRegressR")
...
```{r, table_first_genes}
path_TSV <- system.file("extdata/E.coli", "TUSet.tsv", package = "MotifRegressR")
path_PRO <- system.file("extdata/E.coli", "511145_protein_info_v12_0.txt", package = "MotifRegressR")
